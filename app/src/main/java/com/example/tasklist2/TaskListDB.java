...
public class TaskListDB {
    ...
    public static final String CREATE_LIST_TABLE= "CREATE TABLE " + LIST_TABLE + " (" + LIST_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + LIST_NAME + " TEXT NOT NULL UNIQUE);";
    ...
    public static final String DROP_LIST_TABLE = "DROP TABLE IF EXISTS " + LIST_NAME;
    ...
    private static class DBHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db){
            ...
            db.execSQL("INSERT INTO task VALUES (2, 1, 'Get hair cut', " + "'', '0', '0')");
            db.execSQL("INSERT INTO task VALUES (3, 1, 'Play Soccer', " + "'', '0', '0')");
            db.execSQL("INSERT INTO task VALUES (4, 1, 'Do homework', " + "'', '0', '0')");
            db.execSQL("INSERT INTO task VALUES (5, 1, 'Start a new project', " + "'', '0', '0')");
    ...
    public  ArrayList<Task> getTasks(String listName){
        String where =
                TASK_LIST_ID + "= ? AND " + TASK_HIDDEN + " !='1'";
    ...
    public int updateTask(Task task){
        ...
        String where = TASK_ID + "= ?";
        String[] whreArgs = { String.valueOf(task.getId())};

        this.openWriteableDB();
        int rowCount = db.update(TASK_TABLE, cv, where, whreArgs);
        this.closeDB();
        return rowCount;
